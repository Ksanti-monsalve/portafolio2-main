...
const i18n = {
  es: {
    ...
    project_1_desc: "Simulador de torneo con logica de clasificacion, gestion de partidos y persistencia de datos.",
  ...
  en: {
    ...
    project_1_desc: "Tournament simulator with ranking logic, match management and data persistence.",
