...
const i18n = {
  es: {
    ...
    project_2_desc: "Sitio de venta de autos de lujo con catalogo premium, fichas tecnicas y diseno orientado a conversion.",
  ...
  en: {
    ...
    project_2_desc: "Luxury car sales website with a premium catalog, spec sheets and conversion-focused design.",
